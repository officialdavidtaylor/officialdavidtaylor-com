...
export interface ApiRecordRecord extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    artist: Schema.Attribute.Relation<'manyToOne', 'api::artist.artist'> &
      Schema.Attribute.Required;
    coverArt: Schema.Attribute.Media<'images'> & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    giver: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::record.record'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    receivedOn: Schema.Attribute.DateTime & Schema.Attribute.Required;
